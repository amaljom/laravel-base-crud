...
class ComicsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($books as $book){
            $newComic = new Comic();
            $newComic->title = $book['title'];
            $newComic->description = $book['description'];
            $newComic->thumb = $book['thumb'];
            $newComic->price= $book['price'];
            $newComic->series= $book['series'];
            $newComic->sale_date = $book['sale_date'];
            $newComic->type =$book['type'];
